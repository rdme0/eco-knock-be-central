drop materialized view if exists air_quality_1m_mv;
drop materialized view if exists air_quality_5m_mv;
drop materialized view if exists air_quality_15m_mv;
drop materialized view if exists air_quality_1h_mv;
drop materialized view if exists air_quality_4h_mv;
drop materialized view if exists air_quality_1d_mv;
