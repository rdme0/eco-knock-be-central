...
import jnu.econovation.ecoknockbecentral.airpurifier.dto.internal.CurrentAirPurifierDTO
...
class AirPurifierGrpcClient(
    ...
    suspend fun getCurrentAirPurifier(): CurrentAirPurifierDTO {
        val response = stub
